  	...
  	?>
		...
		<div class="container">
			...
			<div class="category-controll text-center">
				...
				<button class="btn" type="button" data-filter=".<?= get_category( 19, ARRAY_A )['slug'] ?>"><?= get_category( 19, ARRAY_A )['name'] ?></button>
				<button class="btn" type="button" data-filter=".<?= get_category( 20, ARRAY_A )['slug'] ?>"><?= get_category( 20, ARRAY_A )['name'] ?></button>
				<button class="btn" type="button" data-filter=".<?= get_category( 21, ARRAY_A )['slug'] ?>"><?= get_category( 21, ARRAY_A )['name'] ?></button>
				...
				if(have_posts()){
					while(have_posts()){
						...
						foreach($all_category as $category){
							if($category->term_id == 19 || $category->term_id == 20 || $category->term_id == 21){
			...
			<!-- Вместо этого кода функция ниже<nav class="navigation pagination" role="navigation">
